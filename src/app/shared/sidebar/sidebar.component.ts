      ...
      children: [
        {
          ...
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Impuestos sobre el patrimonio', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Impuestos sobre la renta', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Impuesto predial', route: '/admin/ley-ingresos' }
          ]
        },
        {
          icon: 'fas fa-lock custom-icon',
          label: 'Ventas de activos',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Activos fijos', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Activos corrientes', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Activos intangibles', route: '/admin/ley-ingresos' }
          ]
        },
        {
          icon: 'fas fa-lock custom-icon',
          ...
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Participaciones de ingresos federales', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Participaciones de ingresoos empresariales', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Participaciones de ingresos de tipo privado', route: '/admin/ley-ingresos' }
          ]
        }
      ]
    },
      ...
      children: [
        {
          ...
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Modificación de Permisos de apertura', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Revalidación del permiso para la apertura', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Certificación de pago de contribuciones', route: '/admin/ley-ingresos' }
          ]
        },
        {
          icon: 'fas fa-lock custom-icon',
          ...
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Declaración definitiva sobre las demandas', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Declaración definitiva impuesto sobre prestación de servicios', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Inscripción al registro estatal de contribuyentes', route: '/admin/ley-ingresos' }
          ]
        },
        {
          icon: 'fas fa-lock custom-icon',
          ...
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Certificación de pago de contribuciones', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Devolución y compensación', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Expedición de copias certificadas de expedientes', route: '/admin/ley-ingresos' }
          ]
        }
      ]
    },
      ...
      children: [
        {
          ...
          icon: 'folder',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Ingresos corrientes', route: '/admin/cuentas-contables' },
        ...
        },
        {
          ...
          icon: 'folder',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Impuestos directos', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Ventas de activos', route: '/admin/ley-ingresos' },
            { icon: 'fas fa-lock custom-icon', label: 'Participaciones', route: '/admin/ley-ingresos' }
          ]
        }
      ]
    },
      ...
      children: [
        {
          ...
          icon: 'folder',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Alta de usuarios', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Gestión de usuarios', route: '/admin/ley-ingresos' },
          ]
        },
        {
          label: 'Roles',
          icon: 'folder',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Gestión de roles', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-lock custom-icon', label: 'Permisos de roles', route: '/admin/ley-ingresos' }
          ]
        },
        {
          label: 'Opciones',
          icon: 'folder',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Reestablecer contraseña', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-user custom-icon', label: 'Actualizar privilegios', route: '/admin/cuentas-contables' },
          ]
        },
        {
          label: 'Bitacora',
          icon: 'folder',
          children: [
            { icon: 'fas fa-user custom-icon', label: 'Reportes de usuarios', route: '/admin/cuentas-contables' },
            { icon: 'fas fa-user custom-icon', label: 'Actividad de usuarios', route: '/admin/cuentas-contables' },
          ]
        },
      ]
    },
